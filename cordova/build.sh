...
if [ ! -d $PROJECT ]; then
  ...
  cordova plugin add https://github.com/cmgustavo/Custom-URL-scheme.git#f96aa49e7cca9d655e07f83935e1324b6f5af0bd --variable URL_SCHEME=groestlcoin --variable SECOND_URL_SCHEME=groestlpay
  checkOK
  ...
  cordova plugin add https://github.com/danielsogl/cordova-plugin-clipboard.git
  checkOK
